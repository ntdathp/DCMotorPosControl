...
void Motor_Control_STR_step(void)
{
   ...
   */
  PHI_0 = trunc(Case);
  if (rtIsNaN(PHI_0) || rtIsInf(PHI_0)) {
    PHI_0 = 0.0;
  } else {
    PHI_0 = fmod(PHI_0, 4.294967296E+9);
  }

  switch (PHI_0 < 0.0 ? -(int32_T)(uint32_T)-PHI_0 : (int32_T)(uint32_T)PHI_0) {
   case 1:
   ...
   case 2:
    ...
    for (i = 0; i < 4; i++) {
      PHI_tmp = i << 2;
      b_gamma += (((Motor_Control_STR_DW.UnitDelay1_DSTATE[PHI_tmp + 1] *
                    -Motor_Control_STR_DW.UnitDelay5_DSTATE +
    ...
    a = 1.0 / lamda;
    for (i = 0; i < 4; i++) {
      q2 = ((Motor_Control_STR_DW.UnitDelay1_DSTATE[i + 4] *
             -Motor_Control_STR_DW.UnitDelay5_DSTATE +
      ...
      PHI_0 += (((Motor_Control_STR_DW.UnitDelay1_DSTATE[PHI_tmp + 1] *
                ...
                Motor_Control_STR_DW.UnitDelay1_DSTATE[PHI_tmp + 3] *
                Motor_Control_STR_DW.UnitDelay2_DSTATE) * PHI[i];
      Motor_Control_STR_B.Theta[i] = q2 / (lamda + b_gamma) * rtb_Sum +
    ...
    q2 = (((exp(-2.0 * xi * wn * 0.005) * Motor_Control_STR_B.Theta[2] -
    ...
    d1 = ((((Motor_Control_STR_B.Theta[1] / Motor_Control_STR_B.Theta[3] -
             ((Motor_Control_STR_B.Theta[2] / Motor_Control_STR_B.Theta[3] -
              ...
              1.0) * q2) * Motor_Control_STR_DW.UnitDelay_DSTATE_f + (((d1 + 1.0)
    ...
    for (i = 0; i < 4; i++) {
      b_gamma = PHI[i];
      PHI_tmp = i << 2;
      Theta_tmp_0[PHI_tmp] = q2 * b_gamma;
      Theta_tmp_0[PHI_tmp + 1] = rtb_Sum_o * b_gamma;
      Theta_tmp_0[PHI_tmp + 2] = rtb_NProdOut * b_gamma;
      Theta_tmp_0[PHI_tmp + 3] = Theta_tmp_1 * b_gamma;
    }
    ...
    for (i = 0; i < 4; i++) {
      ...
      for (PHI_tmp = 0; PHI_tmp < 4; PHI_tmp++) {
        ...
        tmp[tmp_1] = Motor_Control_STR_DW.UnitDelay1_DSTATE[tmp_1] -
          (((Motor_Control_STR_DW.UnitDelay1_DSTATE[tmp_0 + 1] * q2 +
    ...
    Motor_Control_STR_DW.UnitDelay3_DSTATE_d = d1;
